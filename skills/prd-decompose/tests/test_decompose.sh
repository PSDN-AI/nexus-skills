#!/usr/bin/env bash
# test_decompose.sh — Integration tests for PRD Decompose
set -euo pipefail
...
test_version_flag() {
  ...
  assert_contains "$output" "prd-decompose" "version flag outputs tool name"
...
test_simple_prd() {
  ...
  assert_contains "$meta" "generator: \"prd-decompose@0.1.0\"" "meta.yaml has generator field"
...
# Run all tests
# ============================================================
echo ">> prd-decompose integration tests"
echo ""
