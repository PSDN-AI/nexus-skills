...
./skills/prd-decompose/scripts/decompose.sh /path/to/prd.md --output /path/to/output
...
./skills/prd-decompose/scripts/decompose.sh /path/to/prd.md --taxonomy /path/to/custom.yaml

# Verbose mode
./skills/prd-decompose/scripts/decompose.sh /path/to/prd.md --verbose
```
...
See [domain-taxonomy.yaml](https://github.com/PSDN-AI/nexus-skills/blob/main/skills/prd-decompose/references/domain-taxonomy.yaml) for the default domain definitions and keywords.
...
The default taxonomy defines eight domains. See [domain-taxonomy.yaml](https://github.com/PSDN-AI/nexus-skills/blob/main/skills/prd-decompose/references/domain-taxonomy.yaml) for the full keyword list.
...
See [output-schema.md](https://github.com/PSDN-AI/nexus-skills/blob/main/skills/prd-decompose/references/output-schema.md) for the detailed output format specification.
